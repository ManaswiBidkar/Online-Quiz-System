...
<body style="background-image: url('image/book.png');background-position: center center;
    ...
    <nav class="navbar navbar-default title1">
        ...
        <li <?php echo'User Logout'; ?> > <a href="logout.php?q=welcome.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Log out</a></li>
        </ul>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if(@$_GET['q']==1) 
                {
                    ...
                    echo '<center><p style="color:#000;font-size:30px;font-weight:bold">SOLVE THIS QUIZ</p></center>';
                    ...
                    {
                    echo '<tr style="color:#000"><td><center>'.$c++.'</center></td><td><center>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></center></td><td><center>'.$total.'</center></td><td><center>'.$sahi*$total.'</center></td><td><center><b><a href="update.php?q=quizre&step=25&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="color:black;margin:0px;background:red"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Restart</b></span></a></b></center></td></tr>';
                    }
                    }
                    $c=0;
                    echo '</table></div></div>';
                ...
                <?php
                    ...
                    if(@$_GET['q']== 'result' && @$_GET['eid']) 
                    {
                        ...
                        <center><h1 class="title" style="color:#000">Result</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
