...
<body style="background-image: url('image/book.png'); width: 100%;
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php
                    ...
                    {
                        echo '<div class="row"><span class="title1" style="margin-left:5%;font-size:30px;color:#000;"><b>Enter Quiz Details</b></span><br /><br />
                        ...
                        <form class="form-horizontal title1" name="form" action="update.php?q=addquiz"  method="POST">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12"> 
                                        <input  type="submit" style="margin-left:80%;background:black;color:white" class="btn btn-primary" value="Submit" class="btn btn-primary"/>
                                    </div>
                                </div>
                ...
                <?php
                    if(@$_GET['q']==4 && (@$_GET['step'])==2 ) 
                    {
                        ...
                        echo '<div class="form-group">
                                <label class="col-md-12 control-label" for=""></label>
                                <div class="col-md-12"> 
                                    <input  type="submit" style="margin-left:45%;background:black;color:white" class="btn btn-primary" value="Submit" class="btn btn-primary"/>
                                </div>
                              </div>
                ...
                <?php 
                    if(@$_GET['q']==5) 
                    {
                        ...
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            <td><center><b><a href="update.php?q=rmquiz&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:black;color:white"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></center></td></tr>';
                        }
                        $c=0;
                        echo '</table></div></div>';
                    }
